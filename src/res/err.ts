...
Tên đăng nhập có thể chứa các chữ cái (a-z), số (0-9) Tên đăng nhập không chứa viết hoa. Tên người dùng không được chứa dấu và (&), dấu bằng (=), dấu gạch dưới (_), dấu nháy đơn ('), dấu gạch ngang (-), dấu cộng (+), dấu phẩy (,), dấu ngoặc vuông (<,>), và dấu chấm (.).`;
